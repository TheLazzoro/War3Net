    ...
    public static class LightEnvironmentProvider
    {
        public static string GetTerrainLightEnvironmentModel(Tileset tileset)
        {
            switch (tileset)
            {
                ...
                case Tileset.CityscapeRuins: return @"Environment\DNC\DNCDalaran\DNCDalaranTerrain\DNCDalaranTerrain.mdl";
                ...
                case Tileset.LordaeronCapital: return @"Environment\DNC\DNCLordaeron\DNCLordaeronTerrain\DNCLordaeronTerrain.mdl";
                case Tileset.LordaeronCapitalRuins: return @"Environment\DNC\DNCDalaran\DNCDalaranTerrain\DNCDalaranTerrain.mdl";
                ...
                case Tileset.Misc: return @"Environment\DNC\DNCLordaeron\DNCLordaeronTerrain\DNCLordaeronTerrain.mdl";
                ...
                case Tileset.Undercity: return @"Environment\DNC\DNCUnderground\DNCUndergroundTerrain\DNCUndergroundTerrain.mdl";
        ...
        public static string GetUnitLightEnvironmentModel(Tileset tileset)
        {
            switch (tileset)
            {
                ...
                case Tileset.CityscapeRuins: return @"Environment\DNC\DNCDalaran\DNCDalaranUnit\DNCDalaranUnit.mdl";
                ...
                case Tileset.LordaeronCapital: return @"Environment\DNC\DNCLordaeron\DNCLordaeronUnit\DNCLordaeronUnit.mdl";
                case Tileset.LordaeronCapitalRuins: return @"Environment\DNC\DNCDalaran\DNCDalaranUnit\DNCDalaranUnit.mdl";
                ...
                case Tileset.Misc: return @"Environment\DNC\DNCLordaeron\DNCLordaeronUnit\DNCLordaeronUnit.mdl";
                ...
                case Tileset.Undercity: return @"Environment\DNC\DNCUnderground\DNCUndergroundUnit\DNCUndergroundUnit.mdl";
